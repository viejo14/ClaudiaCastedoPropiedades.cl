      ...
      <div className="max-w-6xl mx-auto px-4 py-10 grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
        ...
        <div className="flex flex-col gap-2 text-sm md:text-left text-center items-center md:items-start">
          <img
            ...
            alt="Logo"
            className="bg-white w-26 h-26 object-contain rounded-xl p-0 shadow-lg mb-2"
          />
        ...
        <div className="flex flex-col gap-2 items-center">
          ...
          <div className="flex gap-4">
            <a
              ...
              rel="noopener"
              aria-label="Facebook"
              className="bg-white/10 p-2 rounded-full hover:bg-white/30 transition-transform duration-200 hover:scale-110"
            >
